        ...
        <div className='dados'>
            ...
            <div className="selectionConfig">
                <div className="camposFonte">
                    <div>
                        <label htmlFor="selectD5_0">Somar</label>
                        <select id='selectD5_0' value={selectValor0} onChange={(e) => handleOpt0(e.target.value)} className="form-select">
                    ...
                    <div>
                        <label htmlFor="selectD5_1">Visualizar por</label>
                        <select id='selectD5_1' value={selectValor1} onChange={(e) => handleOpt1(e.target.value)} className="form-select">
                    ...
                    <div>
                        <label htmlFor="selectD5_2">Detalhar por</label>
                        <select id='selectD5_2' value={selectValor2} onChange={(e) => handleOpt2(e.target.value)} className="form-select">
